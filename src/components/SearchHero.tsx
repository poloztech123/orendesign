...
export default function SearchHero({
  ...
  const customSlides = featuredImages.filter(Boolean).map((img, idx) => ({
    image: img,
    alt: `Featured architectural project ${idx + 1}`,
    tag: "Featured Architectural Blueprint",
    description: "Discover a curated marketplace of premium blueprints, engineered for modern living and construction excellence."
  }));
  ...
  return (
    <header className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-stone-950">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-stone-950/70 via-stone-950/50 to-stone-950 z-1" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_30%,rgba(12,10,9,0.85)_100%)] z-1" />
      </div>
              ...
              {slides.map((_, idx) => (
                ...
                >
                  <div className="relative h-1 w-10 bg-white/20 rounded-full overflow-hidden">
                    <div
                      className={`absolute inset-y-0 left-0 bg-gradient-to-r from-white via-[#84e114] to-white transition-all duration-500 ${
        ...
        <div className="mt-12 md:mt-16 max-w-5xl mx-auto">
          ...
          <div className="mt-4 flex flex-wrap justify-center gap-2 text-xs text-stone-300">
            ...
            <button
              ...
              className="hover:text-[#84e114] transition-colors font-medium border-b border-white/20 hover:border-[#84e114] pb-0.5 cursor-pointer"
            >
