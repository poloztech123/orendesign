...
export default function Collections({ onSelectStyle, activeStyle }: CollectionsProps) {
  const collections = [
    {
        ...
        {collections.map((col) => {
          ...
          return (
            ...
            >
              ...
              {/* Card Badge */}
              <div className="absolute top-5 left-5 bg-[#1B4332] text-white font-mono text-[9px] font-bold tracking-widest uppercase px-2.5 py-1 rounded-sm shadow-sm">
                {col.badge}
              </div>
